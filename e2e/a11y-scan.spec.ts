...
// Everything from this marker to the end of docs/a11y-audit.md is hand-written
// (the manual assistive-technology walkthrough, #2047) and is carried over
// verbatim on every regenerate. axe cannot produce it and must not erase it.
const MANUAL_MARKER = '<!-- MANUAL SECTION — hand-written, carried over verbatim on every regenerate. Keep this marker. -->';
...
/** The hand-written tail of the report, read back off disk so it survives. */
