    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-gray-200 p-8">
        ...
        <div className="space-y-6 text-sm text-gray-600">
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">{c.expectedTitle}</h2>
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">{c.unacceptableTitle}</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-semibold text-gray-900 mb-2">{c.scopeTitle}</h2>
            <p>{c.scope}</p>
          </section>

          <section>
            <h2 className="font-semibold text-gray-900 mb-2">{c.reportTitle}</h2>
            <p>{c.report}</p>
          </section>

          <section>
            <h2 className="font-semibold text-gray-900 mb-2">{c.enforcementTitle}</h2>
            <p>{c.enforcement}</p>
          </section>

          <section>
            <h2 className="font-semibold text-gray-900 mb-2">{c.repoTitle}</h2>
            <p>{c.repoBody}</p>
            <a
              href={REPO_COC_URL}
              target="_blank"
