...
// The mentor application form. Split out of the page (#1197) so the page itself
// can stay a server component and wear the shared public chrome.
export function ApplyMentorForm() {
  const t = useT();
  // Sent with the application so the confirmation email goes out in the
  // language the applicant was reading.
