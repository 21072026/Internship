...
export function MeetingRequestsPanel({
  ...
  return (
    <Card>
      ...
      {/* Picking one of the mentor's offered slots is a write action like the
          form below, so an archived mentorship closes both (#1408). */}
      {mode === 'request' && !readOnly && hasOffers && (
