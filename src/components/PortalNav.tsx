...
import { PORTAL_NAV_LINKS, visibleNavLinks } from '@/lib/navLinks';
...
export function PortalNav({ capabilities }: { capabilities?: readonly VerticalCapability[] }) {
  const LINKS = useMemo(() => (capabilities ? visibleNavLinks(PORTAL_NAV_LINKS, capabilities) : PORTAL_NAV_LINKS), [capabilities]);
  const t = useT();
