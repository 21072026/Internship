  ...
  MARKETING: {
    en: {
      ...
      landing: {
        ...
        pipelineStagesNote: 'Under the hood: seven granular stages — from new lead to won or lost — with a service level per stage and overdue flags, all editable per team.',
        pipelineNote: 'Not every lead closes: lost deals are recorded too, so the funnel tells you the truth.',
        stageApply: 'New lead',
        stageInterview: 'Contacted',
        stageInternship: 'Proposal',
        stageHired: 'Won',
        ...
        more3: 'Lead-source tracking with conversion analytics',
        ...
        more6: 'Duplicate detection and one-click merge for leads and accounts',
        ...
        ctaSubtitle: 'Set up your pipeline in minutes. No card, no seat count, no trial that runs out.',
        ctaMentee: 'Get started',
    ...
    tr: {
      ...
      landing: {
        ...
        pipelineStagesNote: 'Arka planda: yeni adaydan kazanıldı ya da kaybedildiye yedi ayrıntılı aşama — aşama başına hizmet seviyesi ve gecikme işaretleri, hepsi ekip başına düzenlenebilir.',
        ...
        more3: 'Dönüşüm analitikli aday kaynağı takibi',
        ...
        more6: 'Aday ve firmalarda yinelenen tespiti ve tek tıkla birleştirme',
        ...
        ctaSubtitle: 'Hattınızı dakikalar içinde kurun. Kart yok, koltuk sayısı yok, süresi biten deneme yok.',
        ctaMentee: 'Hemen başla',
    ...
    de: {
      ...
      landing: {
        ...
        pipelineStagesNote: 'Unter der Haube: sieben granulare Phasen — von neuer Lead bis gewonnen oder verloren — mit Service-Level pro Phase und Überfälligkeitsmarkern, alles pro Team anpassbar.',
        ...
        more3: 'Lead-Quellen-Tracking mit Conversion-Analytics',
        ...
        more6: 'Duplikaterkennung und Zusammenführen per Klick für Leads und Accounts',
        ...
        ctaSubtitle: 'Richten Sie Ihre Pipeline in Minuten ein. Keine Karte, keine Sitzplatzzahl, keine ablaufende Testphase.',
        ctaMentee: 'Loslegen',
