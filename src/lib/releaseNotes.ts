...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    highlights: {
      en: [
        "The installed app now offers home-screen shortcuts to messages, to-dos and notifications, opens on an iOS launch screen instead of a blank page, and can receive a link shared from another app — nothing is saved until you confirm it. Tablets are no longer locked to portrait.",
      ],
      tr: [
        "Kurulu uygulama artık ana ekrandan mesajlar, yapılacaklar ve bildirimler için kısayol sunuyor, iOS'ta boş ekran yerine açılış ekranıyla başlıyor ve başka bir uygulamadan paylaşılan bağlantıyı alabiliyor — siz onaylamadan hiçbir şey kaydedilmiyor. Tabletler artık dikey moda kilitli değil.",
      ],
      de: [
        "Die installierte App bietet jetzt Startbildschirm-Kurzbefehle für Nachrichten, To-dos und Benachrichtigungen, startet unter iOS mit einem Launch-Screen statt einer leeren Seite und nimmt aus anderen Apps geteilte Links entgegen — gespeichert wird erst nach deiner Bestätigung. Tablets sind nicht mehr aufs Hochformat festgelegt.",
      ],
    },
  },
  {
    ...
    highlights: {
      en: [
        "A new invitation board shows who was invited, who opened the link and who actually joined — with filters, per-status counts, CSV export, and bulk re-invite, revoke or delete.",
      ],
      tr: [
        "Yeni davet panosu kimin davet edildiğini, kimin bağlantıyı açtığını ve kimin gerçekten katıldığını gösteriyor — filtreler, durum sayaçları, CSV dışa aktarım ve toplu yeniden davet, iptal veya silme ile birlikte.",
      ],
      de: [
        "Eine neue Einladungsübersicht zeigt, wer eingeladen wurde, wer den Link geöffnet hat und wer wirklich beigetreten ist — mit Filtern, Statuszählern, CSV-Export sowie Sammelaktionen zum erneuten Einladen, Widerrufen oder Löschen.",
      ],
    },
  },
  {
    ...
    highlights: {
      en: [
        "The theme button now cycles System → Light → Dark, so you can hand the theme back to your device — and it follows a live system switch.",
        "New compact density option tightens tables and lists without shrinking any button.",
      ],
      tr: [
        "Tema düğmesi artık Sistem → Açık → Koyu sırasıyla dönüyor; temayı cihazına geri bırakabilir, sistem değiştiğinde anında takip edebilirsin.",
        "Yeni \"sık\" yoğunluk seçeneği, hiçbir düğmeyi küçültmeden tabloları ve listeleri sıkıştırıyor.",
      ],
      de: [
        "Die Theme-Schaltfläche wechselt jetzt System → Hell → Dunkel — du kannst das Theme wieder deinem Gerät überlassen, und ein Systemwechsel wird sofort übernommen.",
        "Neue kompakte Dichte verdichtet Tabellen und Listen, ohne Schaltflächen zu verkleinern.",
      ],
    },
  },
  {
    version: '0.132.0-beta',
    date: '2026-09-02',
    time: '15:37',
    commit: 'f1a43fb',
    highlights: {
      en: [
        "Empty screens now explain what they are for and offer the next step that fits your role — an admin is asked to invite people, a mentor is told their mentees appear once an admin assigns them.",
      ],
      tr: [
        "Boş ekranlar artık ne işe yaradıklarını anlatıyor ve rolüne uygun bir sonraki adımı sunuyor — yöneticiye \"insanları davet et\", mentora \"bir yönetici mentee atadığında burada görünecekler\".",
      ],
      de: [
        "Leere Bildschirme erklären jetzt, wofür sie da sind, und bieten den nächsten Schritt passend zur Rolle — Admins werden gebeten, Leute einzuladen, Mentoren erfahren, dass ihre Mentees nach der Zuweisung durch einen Admin erscheinen.",
      ],
    },
  },
  {
    ...
    highlights: {
      en: [
        "Global search can now be driven entirely from the keyboard, is announced properly by screen readers, says when there are no results, and is readable in dark mode.",
      ],
      tr: [
        "Genel arama artık tamamen klavyeyle kullanılabiliyor, ekran okuyucular tarafından doğru okunuyor, sonuç bulunamadığında bunu söylüyor ve koyu modda okunaklı.",
      ],
      de: [
        "Die globale Suche lässt sich jetzt vollständig per Tastatur bedienen, wird von Screenreadern korrekt angesagt, meldet fehlende Treffer und ist im Dunkelmodus lesbar.",
      ],
    },
  },
  {
    ...
    highlights: {
      en: [
        "Mentor analytics: pick a date range, export your mentees to Excel and print the page as a report.",
      ],
      tr: [
        "Mentor analitiği: tarih aralığı seç, mentee'lerini Excel'e aktar ve sayfayı rapor olarak yazdır.",
      ],
      de: [
        "Mentor-Analysen: Zeitraum wählen, Mentees nach Excel exportieren und die Seite als Bericht drucken.",
      ],
    },
  },
  {
    version: '0.130.1-beta',
    date: '2026-09-02',
    time: '10:41',
    commit: '045bdba',
    highlights: {
      en: [
        "The mentee interactions page (`/portal/interactions`) is now fully localized in English, Turkish and German.",
      ],
      tr: [
        "Mentee etkileşimler sayfası (`/portal/interactions`) artık İngilizce, Türkçe ve Almanca dillerinde tam olarak yerelleştirildi.",
      ],
      de: [
        "Die Mentee-Interaktionsseite (`/portal/interactions`) ist jetzt vollständig in Englisch, Türkisch und Deutsch lokalisiert.",
      ],
    },
  },
  {
    ...
    highlights: {
      en: [
        "The app now follows your system settings for reduced motion, higher contrast and Windows High Contrast mode: animations stop, borders and secondary text get stronger, and the keyboard focus ring stays visible.",
      ],
      tr: [
        "Uygulama artık işletim sisteminizin hareketi azaltma, yüksek kontrast ve Windows Yüksek Kontrast ayarlarına uyuyor: animasyonlar duruyor, kenarlıklar ve ikincil metinler belirginleşiyor, klavye odak halkası görünür kalıyor.",
      ],
      de: [
        "Die App folgt jetzt Ihren Systemeinstellungen für reduzierte Bewegung, höheren Kontrast und den Windows-Modus für hohen Kontrast: Animationen stoppen, Rahmen und sekundärer Text werden kräftiger, und der Tastaturfokus bleibt sichtbar.",
      ],
    },
  },
  {
    ...
    highlights: {
      en: [
        "Enterprise SSO: hand your identity team one metadata URL instead of copying identifiers by hand — the tenant's Entity ID, ACS URL and metadata URL are now shown with copy buttons.",
      ],
      tr: [
        "Kurumsal SSO: kimlik ekibine artık tek bir metadata adresi verebilirsin — kiracının Entity ID, ACS ve metadata adresleri kopyalama düğmeleriyle görünüyor.",
      ],
      de: [
        "Enterprise SSO: Ihr Identity-Team erhält jetzt eine Metadaten-URL statt handkopierter Werte — Entity ID, ACS-URL und Metadaten-URL des Mandanten stehen mit Kopierbuttons bereit.",
      ],
    },
  },
  {
